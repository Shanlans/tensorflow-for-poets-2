...
def flip_image(dirpath):
    for filename in os.listdir(dirpath):
        ...
        if len(name) == 4:
            ...
            h_image_name= name[0]+'_'+name[1]+'_'+name[2]+'_'+'h'+'_'+name[3]+'_'+name[4]
            v_image_name= name[0]+'_'+name[1]+'_'+name[2]+'_'+'v'+'_'+name[3]+'_'+name[4]
            b_image_name= name[0]+'_'+name[1]+'_'+name[2]+'_'+'b'+'_'+name[3]+'_'+name[4]
